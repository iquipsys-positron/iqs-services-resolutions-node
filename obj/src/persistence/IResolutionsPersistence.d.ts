...
export interface IResolutionsPersistence extends IGetter<ResolutionV1, string>, IWriter<ResolutionV1, string> {
    ...
    getOneById(correlationId: string, id: string, callback: (err: any, item: ResolutionV1) => void): void;
    create(correlationId: string, item: ResolutionV1, callback: (err: any, item: ResolutionV1) => void): void;
    update(correlationId: string, item: ResolutionV1, callback: (err: any, item: ResolutionV1) => void): void;
    deleteById(correlationId: string, id: string, callback: (err: any, item: ResolutionV1) => void): void;
